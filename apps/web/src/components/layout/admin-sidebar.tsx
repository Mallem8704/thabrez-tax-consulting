...
import { BrandLogo } from '@thabrez/ui';
import {
  LayoutDashboard,
  Users,
  Briefcase,
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-zinc-900 border-b border-zinc-800 sticky top-0 z-40">
        <Link href="/admin" className="flex items-center gap-2.5">
          ...
          <span className="font-mono text-xs font-bold tracking-wide text-white">
            STAFF <span className="text-[#E8823A]">CONSOLE</span>
          </span>
        </Link>
        <button
          type="button"
      ...
      >
        ...
        <div className="h-16 px-6 border-b border-zinc-800 flex items-center justify-between">
          <Link href="/admin" className="flex items-center gap-2.5" onClick={() => setMobileOpen(false)}>
            <BrandLogo variant="dark" size="sm" />
            <div>
              <div className="font-mono text-xs font-bold tracking-wider text-white flex items-center gap-1.5">
                THABREZ
                <span className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
              </div>
              <div className="text-[9px] uppercase tracking-widest text-zinc-400 font-semibold">
                Staff Console
              </div>
            </div>
          </Link>
